...
interest. For reference, this trial was registered with
[ClinicalTrials.gov](https://clinicaltrials.gov) as NCT01590095.
...
# read in data
dat <- fread("https://raw.githubusercontent.com/tlverse/tlverse-data/master/wash-benefits/washb_data.csv",
...
For the purposes of this workshop, we start by treating the data as
